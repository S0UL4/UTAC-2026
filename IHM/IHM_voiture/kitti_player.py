...
import numpy as np
import os
import psutil  # Pour lire la vraie batterie de l'ordinateur
...
class KittiPlayer(Node):
    def __init__(self):
        ...
        # Canal pour la batterie réelle de l'ordinateur
    ...
    def timer_callback(self):
        ...
        if battery is not None:
            ...
            battery_percent = 0.0
            self.get_logger().warning("Batterie non détectée sur cet ordinateur.")
