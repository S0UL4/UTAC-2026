...
describe("createCommand", () => {
    it("creates a skeleton extension package", async () => {
        await (0, create_1.createCommand)({ name: "extension-test", cwd: tmpdir, dirname: tmpdir });
        ...
        await (0, package_1.packageCommand)({ cwd: destDir }); // make sure the skeleton package is buildable and packagable
